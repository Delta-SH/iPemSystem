...
namespace iPem.Services.Sc {
    ...
    /// 组态配置API
    /// </summary>
    public partial interface IGPageService {
        /// <summary>
        /// 获得指定组态名称的组态对象
        /// </summary>
        /// <param name="name">组态名称</param>
        /// <returns>组态对象</returns>
        G_Page GetPage(string name);
        ...
        /// <returns>组态对象集合</returns>
        List<G_Page> GetPages(string role);
        ...
        /// <returns>组态对象集合</returns>
        List<G_Page> GetPages(string role, string id, int type);
        ...
        void Add(params G_Page[] entities);

        /// <summary>
        /// 更新组态对象
        /// </summary>
        /// <param name="entities">需要更新的组态对象集合</param>
        void Update(params G_Page[] entities);
