...
namespace iPem.Data.Common {
    ...
    public static class SqlCommands_Rs {
        ...
        //station repository
        public const string Sql_Station_Repository_GetEntity = @"SELECT [Id],[Name],[StaTypeId],[Longitude],[Latitude],[Altitude],[CityElecLoadTypeId],[CityElecCap],[CityElecLoad],[Contact],[LineRadiusSize],[LineLength],[SuppPowerTypeId],[TranInfo],[TranContNo],[TranPhone],[ParentId],[AreaId],[Desc] AS [Comment],[Enabled] FROM [dbo].[S_Station] WHERE [Id]=@Id;";
        public const string Sql_Station_Repository_GetEntities = @"SELECT [Id],[Name],[StaTypeId],[Longitude],[Latitude],[Altitude],[CityElecLoadTypeId],[CityElecCap],[CityElecLoad],[Contact],[LineRadiusSize],[LineLength],[SuppPowerTypeId],[TranInfo],[TranContNo],[TranPhone],[ParentId],[AreaId],[Desc] AS [Comment],[Enabled] FROM [dbo].[S_Station];";
        public const string Sql_Station_Repository_GetEntitiesInParent = @"SELECT [Id],[Name],[StaTypeId],[Longitude],[Latitude],[Altitude],[CityElecLoadTypeId],[CityElecCap],[CityElecLoad],[Contact],[LineRadiusSize],[LineLength],[SuppPowerTypeId],[TranInfo],[TranContNo],[TranPhone],[ParentId],[AreaId],[Desc] AS [Comment],[Enabled] FROM [dbo].[S_Station] WHERE [AreaId]=@AreaId;";

        //room repository
        public const string Sql_Room_Repository_GetEntity = @"SELECT [Id],[Name],[RoomTypeId],[PropertyId],[Address],[Floor],[Length],[Width],[Heigth],[FloorLoad],[LineHeigth],[Square],[EffeSquare],[FireFighEuip],[Owner],[QueryPhone],[PowerSubMain],[TranSubMain],[EnviSubMain],[FireSubMain],[AirSubMain],[Contact],[StationId],[Desc] AS [Comment],[Enabled] FROM [dbo].[S_Room] WHERE [Id]=@Id;";
        public const string Sql_Room_Repository_GetEntitiesByParent = @"SELECT [Id],[Name],[RoomTypeId],[PropertyId],[Address],[Floor],[Length],[Width],[Heigth],[FloorLoad],[LineHeigth],[Square],[EffeSquare],[FireFighEuip],[Owner],[QueryPhone],[PowerSubMain],[TranSubMain],[EnviSubMain],[FireSubMain],[AirSubMain],[Contact],[StationId],[Desc] AS [Comment],[Enabled] FROM [dbo].[S_Room] WHERE [StationId]=@Parent;";
        public const string Sql_Room_Repository_GetEntities = @"SELECT [Id],[Name],[RoomTypeId],[PropertyId],[Address],[Floor],[Length],[Width],[Heigth],[FloorLoad],[LineHeigth],[Square],[EffeSquare],[FireFighEuip],[Owner],[QueryPhone],[PowerSubMain],[TranSubMain],[EnviSubMain],[FireSubMain],[AirSubMain],[Contact],[StationId],[Desc] AS [Comment],[Enabled] FROM [dbo].[S_Room];";

        //device repository
        public const string Sql_Device_Repository_GetEntity = @"SELECT [Id],[Name],[Code],[DeviceTypeId],[SubDeviceTypeId],[SysName],[SysCode],[Model],[ProdId],[BrandId],[SuppId],[SubCompId],[StartTime],[ScrapTime],[StatusId],[Contact],[RoomId],[Desc] AS [Comment],[Enabled] FROM [dbo].[D_Device] WHERE [Id]=@Id;";
        public const string Sql_Device_Repository_GetEntitiesByParent = @"SELECT [Id],[Name],[Code],[DeviceTypeId],[SubDeviceTypeId],[SysName],[SysCode],[Model],[ProdId],[BrandId],[SuppId],[SubCompId],[StartTime],[ScrapTime],[StatusId],[Contact],[RoomId],[Desc] AS [Comment],[Enabled] FROM [dbo].[D_Device] WHERE [RoomId]=@Parent;";
        public const string Sql_Device_Repository_GetEntities = @"SELECT [Id],[Name],[Code],[DeviceTypeId],[SubDeviceTypeId],[SysName],[SysCode],[Model],[ProdId],[BrandId],[SuppId],[SubCompId],[StartTime],[ScrapTime],[StatusId],[Contact],[RoomId],[Desc] AS [Comment],[Enabled] FROM [dbo].[D_Device];";
