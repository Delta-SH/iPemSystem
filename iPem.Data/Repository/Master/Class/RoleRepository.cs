...
namespace iPem.Data.Repository.Master {
    public partial class RoleRepository : IRoleRepository {
        ...
        public virtual Role GetEntity(Guid id) {
            ...
            Role entity = null;
            using(var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_Role_Repository_GetEntity1, parms)) {
                if(rdr.Read()) {
                    entity = new Role();
        ...
        public virtual Role GetEntity(string name) {
            ...
            Role entity = null;
            using (var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_Role_Repository_GetEntity2, parms)) {
                if (rdr.Read()) {
                    entity = new Role();
                    entity.Id = SqlTypeConverter.DBNullGuidHandler(rdr["Id"]);
                    entity.Name = SqlTypeConverter.DBNullStringHandler(rdr["Name"]);
        ...
        public virtual Role GetEntityByUid(Guid uid) {
            ...
            Role entity = null;
            using(var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_Role_Repository_GetEntityByUid, parms)) {
                if(rdr.Read()) {
                    entity = new Role();
                    entity.Id = SqlTypeConverter.DBNullGuidHandler(rdr["Id"]);
                    entity.Name = SqlTypeConverter.DBNullStringHandler(rdr["Name"]);
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var entity in entities) {
                        ...
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_Role_Repository_Insert, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var entity in entities) {
                        ...
                        parms[2].Value = SqlTypeConverter.DBNullStringChecker(entity.Comment);
                        parms[3].Value = entity.Enabled;
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_Role_Repository_Update, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
        ...
        public virtual void Delete(List<Role> entities) {
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var entity in entities) {
                        parms[0].Value = SqlTypeConverter.DBNullGuidChecker(entity.Id);
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_Role_Repository_Delete, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
