...
namespace iPem.Data.Repository.Master {
    public partial class UserRepository : IUserRepository {
        ...
        public virtual User GetEntity(Guid id) {
            ...
            User entity = null;
            using (var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_GetEntity1, parms)) {
                if (rdr.Read()) {
                    entity = new User();
        ...
        public virtual User GetEntity(string name) {
            ...
            User entity = null;
            using(var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_GetEntity2, parms)) {
                if(rdr.Read()) {
                    entity = new User();
                    entity.RoleId = SqlTypeConverter.DBNullGuidHandler(rdr["RoleId"]);
                    entity.Id = SqlTypeConverter.DBNullGuidHandler(rdr["Id"]);
        ...
        public virtual List<User> GetEntities(Guid id) {
            ...
            var entities = new List<User>();
            using(var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_GetEntities2, parms)) {
                while(rdr.Read()) {
                    var entity = new User();
                    entity.RoleId = SqlTypeConverter.DBNullGuidHandler(rdr["RoleId"]);
                    entity.Id = SqlTypeConverter.DBNullGuidHandler(rdr["Id"]);
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var entity in entities) {
                        ...
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_Insert, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var entity in entities) {
                        ...
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_Update, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var entity in entities) {
                        ...
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_Delete, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
        ...
        public virtual void SetLastLoginDate(Guid id, DateTime lastDate) {
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    ...
                    SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_Set_LastLoginDate, parms);
                    trans.Commit();
                } catch {
                    trans.Rollback();
                    throw;
        ...
        public virtual void SetFailedPasswordDate(Guid id, DateTime failedDate) {
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    ...
                    SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_Set_FailedPasswordDate, parms);
                    trans.Commit();
                } catch {
                    trans.Rollback();
                    throw;
        ...
        public virtual void SetLockedOut(Guid id, Boolean isLockedOut, DateTime lastLockoutDate) {
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    ...
                    SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_Set_LockedOut, parms);
                    trans.Commit();
                } catch {
                    trans.Rollback();
                    throw;
        ...
        public virtual void ChangePassword(Guid uId, String nPwd, EnmPasswordFormat nFormat, String nSalt) {
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    ...
                    parms[3].Value = nSalt;
                    SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_User_Repository_ChangePwd, parms);
                    trans.Commit();
                } catch {
                    trans.Rollback();
                    throw;
