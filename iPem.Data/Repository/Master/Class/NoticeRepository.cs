...
namespace iPem.Data.Repository.Master {
    public partial class NoticeRepository : INoticeRepository {
        ...
        public virtual Notice GetEntity(Guid id) {
            ...
            Notice entity = null;
            using(var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_Notice_Repository_GetEntity, parms)) {
                if(rdr.Read()) {
                    entity = new Notice();
        ...
        public virtual IList<Notice> GetEntities() {
            var entities = new List<Notice>();
            using(var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_Notice_Repository_GetEntities1, null)) {
                while(rdr.Read()) {
        ...
        public virtual IList<Notice> GetEntities(Guid uid) {
            SqlParameter[] parms = { new SqlParameter("@UserId", SqlDbType.VarChar, 100) };
            parms[0].Value = SqlTypeConverter.DBNullGuidChecker(uid);

            var entities = new List<Notice>();
            using(var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_Notice_Repository_GetEntities2, parms)) {
                while(rdr.Read()) {
                    var entity = new Notice();
                    entity.Id = SqlTypeConverter.DBNullGuidHandler(rdr["Id"]);
                    entity.Title = SqlTypeConverter.DBNullStringHandler(rdr["Title"]);
        ...
        public virtual int GetUnreadCount(Guid uid) {
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                var count = SqlHelper.ExecuteScalar(conn, CommandType.Text, SqlCommands_Cs.Sql_Notice_Repository_GetUnreadCount, parms);
        ...
        public virtual void Insert(IList<Notice> entities) {
            SqlParameter[] parms = { new SqlParameter("@Id", SqlDbType.VarChar,100),
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach(var entity in entities) {
                        ...
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_Notice_Repository_Insert, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
        ...
        public virtual void Update(IList<Notice> entities) {
            SqlParameter[] parms = { new SqlParameter("@Id", SqlDbType.VarChar,100),
                                     new SqlParameter("@Title", SqlDbType.VarChar,512),
                                     new SqlParameter("@Content", SqlDbType.VarChar),
                                     new SqlParameter("@CreatedTime", SqlDbType.DateTime),
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach(var entity in entities) {
                        ...
                        parms[3].Value = SqlTypeConverter.DBNullDateTimeChecker(entity.CreatedTime);
                        parms[4].Value = entity.Enabled;
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_Notice_Repository_Update, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
        ...
        public virtual void Delete(IList<Notice> entities) {
            SqlParameter[] parms = { new SqlParameter("@Id", SqlDbType.VarChar, 100) };
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                conn.Open();
                var trans = conn.BeginTransaction(IsolationLevel.ReadCommitted);
                try {
                    foreach(var entity in entities) {
                        parms[0].Value = SqlTypeConverter.DBNullGuidChecker(entity.Id);
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_Notice_Repository_Delete, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
