...
namespace iPem.Data.Repository.Master {
    public partial class ProfileRepository : IProfileRepository {
        ...
        public virtual UserProfile GetEntity(Guid id) {
            ...
            using(var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Cs.Sql_Profile_Repository_GetEntity, parms)) {
                if(rdr.Read()) {
        ...
        public virtual void Save(UserProfile entity) {
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    ...
                    SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_Profile_Repository_Save, parms);
        ...
        public virtual void Delete(Guid id) {
            ...
            using(var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                var trans = conn.BeginTransaction(IsolationLevel.ReadCommitted);
                try {
                    SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Cs.Sql_Profile_Repository_Delete, parms);
                    trans.Commit();
                } catch {
                    trans.Rollback();
                    throw;
