...
namespace iPem.Data.Repository.Rs {
    public partial class R_DBScriptRepository : IR_DBScriptRepository {
        ...
        /// Ctor
        /// </summary>
        public R_DBScriptRepository(string databaseConnectionString) {
        ...
        public List<R_DBScript> GetEntities() {
            var entities = new List<R_DBScript>();
            using (var rdr = SqlHelper.ExecuteReader(this._databaseConnectionString, CommandType.Text, SqlCommands_Rs.Sql_H_DBScript_Repository_GetEntities, null)) {
                while (rdr.Read()) {
                    var entity = new R_DBScript();
        ...
        public void Insert(IList<R_DBScript> entities) {
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var entity in entities) {
                        ...
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Rs.Sql_H_DBScript_Repository_Insert, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
        ...
        public void Update(IList<R_DBScript> entities) {
            SqlParameter[] parms = { new SqlParameter("@Id", SqlDbType.VarChar,100),
                                     new SqlParameter("@Name", SqlDbType.VarChar,200),
                                     new SqlParameter("@Creator", SqlDbType.VarChar,200),
                                     new SqlParameter("@CreatedTime", SqlDbType.DateTime),
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var entity in entities) {
                        ...
                        parms[5].Value = SqlTypeConverter.DBNullDateTimeChecker(entity.ExecutedTime);
                        parms[6].Value = SqlTypeConverter.DBNullStringChecker(entity.Comment);
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Rs.Sql_H_DBScript_Repository_Update, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
            ...
            using (var conn = new SqlConnection(this._databaseConnectionString)) {
                ...
                try {
                    foreach (var id in ids) {
                        ...
                        SqlHelper.ExecuteNonQuery(trans, CommandType.Text, SqlCommands_Rs.Sql_H_DBScript_Repository_Delete, parms);
                    }
                    trans.Commit();
                } catch {
                    trans.Rollback();
