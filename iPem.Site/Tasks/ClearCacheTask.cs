    ...
    public class ClearCacheTask : ITask {
        ...
        public void Execute() {
            try {
                ...
                logger.Error(EnmEventType.Other, "", "#task.cache.clear", "ClearCacheTask Class", string.Format("Error while running the '{0}' schedule task. {1}", this.Name, exc.Message), null, exc);
            }
        }
