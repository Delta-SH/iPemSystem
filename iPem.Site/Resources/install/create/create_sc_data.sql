...
INSERT INTO [dbo].[U_Menus]([Id],[Name],[Icon],[Url],[Comment],[Index],[LastId],[Enabled]) VALUES(400201,N'历史测值','/content/themes/icons/menu-report-ls.png','/Report/History',N'历史测值提供了系统所有设备信号点产生的历史数据的查询统计、数据导出等功能。',1,4002,1);
INSERT INTO [dbo].[U_Menus]([Id],[Name],[Icon],[Url],[Comment],[Index],[LastId],[Enabled]) VALUES(400202,N'历史告警','/content/themes/icons/menu-report-ls.png','/Report/History',N'历史告警提供了系统所有设备信号点产生的历史告警的查询统计、对比分析、数据导出等功能。',2,4002,1);
