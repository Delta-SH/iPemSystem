(function () {
                  ...
                  if (form.isValid()) {
                      ...
                      form.submit({
                          ...
                          success: function (form, action) {
                              ...
                              Ext.getCmp('seniorConditionPanel').getStore().reload();
                          },
    ...
    var conditionEdit = function (id) {
        if (id == null) {
            var selection = Ext.getCmp('seniorConditionPanel').getSelectionModel();
    ...
    var conditionDelete = function (id) {
        var tree = Ext.getCmp('seniorConditionPanel');
        if (id == null) {
    ...
    var leftSenior = Ext.create('Ext.tree.Panel', {
        ...
        listeners: {
            select: function (me, record, item, index) {
                var disabled = record.getId() === 'root';
    ...
    var centerAllGrid = Ext.create('Ext.grid.Panel', {
        id: 'center-all-grid',
        title: '全部告警',
        glyph: 0xf055,
        ...
        columns: [
            ...
            },
            {
                ...
                renderer: function (value, p, record) {
                    ...
                    return Ext.String.format('<a data="{0}" class="alm-reservation" href="javascript:void(0);">查看</a>', value);
                }
            },
            {
                text: '告警翻转',
    ...
    var centerConfirmGrid = Ext.create('Ext.grid.Panel', {
        id: 'center-confirm-grid',
        title: '已确认告警',
        glyph: 0xf035,
        selType: 'checkboxmodel',
        border: false,
    ...
    var centerReservationGrid = Ext.create('Ext.grid.Panel', {
        id: 'center-reservation-grid',
        title: '工程告警',
        glyph: 0xf045,
        selType: 'checkboxmodel',
        border: false,
    ...
    var centerRecoveryGrid = Ext.create('Ext.grid.Panel', {
        id: 'center-recovery-grid',
        title: '已恢复告警',
        glyph: 0xf057,
        selType: 'checkboxmodel',
        border: false,
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                handler: function (me, event) {
                                    ...
                                    conditionAdd({
                                        stationTypes: Ext.getCmp('station-type-multicombo').getValue(),
        ...
        items: [
            {
                ...
                items: [centerAllGrid, centerConfirmGrid, centerReservationGrid, centerRecoveryGrid]
            }
        ]
    });
