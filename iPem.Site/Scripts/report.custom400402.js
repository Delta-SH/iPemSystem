(function () {
    ...
    var projectWnd = Ext.create('Ext.window.Window', {
        title: $$iPems.lang.Report400402.Window.Project.Title,
        glyph: 0xf045,
        height: 300,
        width: 400,
        modal: true,
        ...
        items: [{
            itemId: 'id',
            labelWidth: 60,
            fieldLabel: $$iPems.lang.Report400402.Window.Project.Fields.Id
        }, {
            itemId: 'startTime',
            labelWidth: 60,
            fieldLabel: $$iPems.lang.Report400402.Window.Project.Fields.StartTime
        }, {
            itemId: 'endTime',
            labelWidth: 60,
            fieldLabel: $$iPems.lang.Report400402.Window.Project.Fields.EndTime
        }, {
            itemId: 'projectName',
            labelWidth: 60,
            fieldLabel: $$iPems.lang.Report400402.Window.Project.Fields.ProjectName
        }, {
            itemId: 'creator',
            labelWidth: 60,
            fieldLabel: $$iPems.lang.Report400402.Window.Project.Fields.Creator
        }, {
            itemId: 'createdTime',
            labelWidth: 60,
            fieldLabel: $$iPems.lang.Report400402.Window.Project.Fields.CreatedTime
        }, {
            itemId: 'comment',
            labelWidth: 60,
            fieldLabel: $$iPems.lang.Report400402.Window.Project.Fields.Comment
        }],
        buttonAlign: 'right',
        buttons: [{
            xtype: 'button',
            ...
            tips: {
                ...
                renderer: function (storeItem, item) {
                    ...
                    this.update(
                        ...
                        $$iPems.lang.Report400402.Chart.PieTotal,
                        total,
                        storeItem.get('name'),
                        storeItem.get('value'),
                        $$iPems.lang.Report400402.Chart.PieRate,
    ...
    Ext.onReady(function () {
        var currentLayout = Ext.create('Ext.panel.Panel', {
            ...
            items: [{
                xtype: 'panel',
                glyph: 0xf030,
                title: $$iPems.lang.Report400402.RateTitle,
                collapsible: true,
                collapseFirst: false,
                margin: '5 0 0 0',
                flex: 1,
                ...
                xtype: 'grid',
                glyph: 0xf029,
                title: $$iPems.lang.Report400402.DetailTitle,
                collapsible: true,
                collapseFirst: false,
                margin: '5 0 0 0',
                flex: 2,
                ...
                columns: [
                    {
                        text: $$iPems.lang.Report400402.Columns.Id,
                        dataIndex: 'index',
                        width: 60
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Area,
                        dataIndex: 'area'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Station,
                        dataIndex: 'station'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Room,
                        dataIndex: 'room'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.DevType,
                        dataIndex: 'devType'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Device,
                        dataIndex: 'device'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Logic,
                        dataIndex: 'logic'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Point,
                        dataIndex: 'point'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Level,
                        dataIndex: 'levelDisplay'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.StartTime,
                        dataIndex: 'startTime'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.EndTime,
                        dataIndex: 'endTime'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Interval,
                        dataIndex: 'interval'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.StartValue,
                        dataIndex: 'startValue'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.EndValue,
                        dataIndex: 'endValue'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.AlmComment,
                        dataIndex: 'almComment'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.NormalComment,
                        dataIndex: 'normalComment'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Frequency,
                        dataIndex: 'frequency'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.EndType,
                        dataIndex: 'endType'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Project,
                        dataIndex: 'project',
                    ...
                    {
                        text: $$iPems.lang.Report400402.Columns.ConfirmedStatus,
                        dataIndex: 'confirmedStatus'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.ConfirmedTime,
                        dataIndex: 'confirmedTime'
                    },
                    {
                        text: $$iPems.lang.Report400402.Columns.Confirmer,
                        dataIndex: 'confirmer'
                    }
                ],
            ...
            dockedItems: [{
                xtype: 'panel',
                glyph: 0xf034,
                title: $$iPems.lang.Report400402.ConditionTitle,
                collapsible: true,
                collapsed: false,
                dock: 'top',
                items: [
                        ...
                        items: [
                            {
                                id: 'rangePicker',
                                xtype: 'DevicePicker',
                                fieldLabel: $$iPems.lang.Report400402.ToolBar.Range,
                            ...
                            },
                            {
                                id: 'startField',
                                xtype: 'datefield',
                                fieldLabel: $$iPems.lang.Report400402.ToolBar.Start,
                                labelWidth: 60,
                                width: 220,
                            ...
                            },
                            {
                                id: 'endField',
                                xtype: 'datefield',
                                fieldLabel: $$iPems.lang.Report400402.ToolBar.End,
                                labelWidth: 60,
                                width: 220,
                                value: Ext.Date.add(new Date(), Ext.Date.DAY, -1),
                                editable: false,
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                xtype: 'button',
                                text: $$iPems.lang.Report400402.ToolBar.OtherOption,
                                menu: [
                                    {
                                        id: 'show-confirm-menu',
                                        xtype: 'menucheckitem',
                                        text: $$iPems.lang.Report400402.ToolBar.ShowConfirm,
                                        checked: false,
                                    ...
                                    },
                                    {
                                        ...
                                        xtype: 'menucheckitem',
                                        text: $$iPems.lang.Report400402.ToolBar.ShowUnConfirm,
                                        checked: false,
                                        checkHandler: function (me, checked) {
                                            if (checked) {
                                    ...
                                    '-',
                                    {
                                        ...
                                        xtype: 'menucheckitem',
                                        text: $$iPems.lang.Report400402.ToolBar.ShowProject,
                                        checked: false,
                                        checkHandler: function (me, checked) {
                                            if (checked) {
                                    ...
                                    },
                                    {
                                        ...
                                        xtype: 'menucheckitem',
                                        text: $$iPems.lang.Report400402.ToolBar.ShowUnProject,
                                        checked: false,
                                        checkHandler: function (me, checked) {
                                            if (checked) {
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                xtype: 'textfield',
                                fieldLabel: $$iPems.lang.Report400402.ToolBar.PointName,
