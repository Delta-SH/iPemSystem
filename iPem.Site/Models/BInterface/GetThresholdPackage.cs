...
namespace iPem.Site.Models.BInterface {
    public partial class GetThresholdPackage {
        public string FsuId { get; set; }

        public List<GetThresholdDevice> DeviceList { get; set; }
        ...
        public virtual string ToXml() {
            ...
            Name.InnerText = EnmBIPackType.GET_THRESHOLD.ToString();
    ...
    public partial class GetThresholdDevice {
