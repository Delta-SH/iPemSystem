...
namespace iPem.Site.Models.BInterface {
    public partial class SetFsuLoginAckPackage {
        public SetFsuLoginAckPackage(string xmlData) {
            ...
            if(!Name.InnerText.Equals(EnmBIPackType.SET_LOGININFO_ACK.ToString())) 
                return;
